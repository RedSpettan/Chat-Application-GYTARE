    ...
    public void run() {
        ...
        while(frame.updateChat){
            ...
            if(!frame.server.messagesToBeDisplayed.isEmpty()){
                ...
                if(scrollValue ==(frame.chatPanel.scrollPane.getVerticalScrollBar().getMaximum() - scrollInitialMaximum)){
                    moveScrollBar = true;
                ...
                if(moveScrollBar){
                    frame.chatPanel.scrollPane.getVerticalScrollBar().setValue(frame.chatPanel.scrollPane.getVerticalScrollBar().getMaximum() - scrollInitialMaximum);
                }
